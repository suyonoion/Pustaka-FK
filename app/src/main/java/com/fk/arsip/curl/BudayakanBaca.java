...
public class BudayakanBaca extends GLSurfaceView implements View.OnTouchListener,
	...
	// LISTENER HALAMAN BERGANTI: BudayakanBaca aslinya tidak punya cara
	...
	public void setPenggantiHalamanListener(PenggantiHalamanListener listener) {
		mPenggantiHalamanListener = listener;
	}

	public interface PenggantiHalamanListener {
